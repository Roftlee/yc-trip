...
public class IDCardUtil {  
    ...
    public static void main(String[] args) throws ParseException {  
        ...
        String IdCard1 ="330726196507040016"; 
        String IdCard2 ="43310119830404053X"; 
        String IdCard3 ="37132319830718652X";
        //从控制端输入用户身份证  
      
        //将身份证最后一位的x转换为大写，便于统一  
        IdCard1 = IdCard1.toUpperCase();  
        System.out.println(IDCardValidate(IdCard1));  
        
        IdCard2 = IdCard2.toUpperCase();  
        System.out.println(IDCardValidate(IdCard2));  
        
        IdCard3 = IdCard3.toUpperCase();  
        System.out.println(IDCardValidate(IdCard3));  
